...
2. Inside your local git repository, create a directory for both of the  Python Challenges. Utse folder names corresponding to the challenges: **PyBank** and  **PyPoll**.
